"""upgrade unmodified builtin prompts for causal transitions

Revision ID: d6e7f8a9b0c1
Revises: c0e6a1b8d4f2
...
down_revision: Union[str, Sequence[str], None] = "c0e6a1b8d4f2"
...
def upgrade() -> None:
    ...
    for stage in ("planner", "writer", "critic", "reviser", "judge"):
        ...
        if not current or current.version_number > 2:
            continue
