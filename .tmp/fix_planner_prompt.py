...
# Find the planner system_template boundaries
planner_start = None
planner_end = None
...
# Build the new planner system_template
new_planner_system = [
    '        "system_template": (\n',
    '            "## \u89d2\u8272\u4e0e\u89c4\u5219\\n"\n',
    ...
    '            "- state_delta\uff1a{before, after} \u884c\u52a8\u524d\u540e\u7684\u72b6\u6001\u53d8\u5316\uff0c\u4e24\u8005\u5fc5\u987b\u4e0d\u540c\\n"\n',
    ...
    '            "\u56e0\u679c\u8f6c\u6298\u5931\u6548\u6761\u4ef6\uff1a\\n"\n',
    '            "1. \u5982\u679c\u4e0d\u91c7\u53d6\u8be5\u884c\u52a8\uff0cimmediate_consequence \u4ecd\u7136\u4f1a\u53d1\u751f\uff0c\u5219\u8be5\u56e0\u679c\u5361\u65e0\u6548\uff0c\u5fc5\u987b\u91cd\u65b0\u89c4\u5212\u3002\\n"\n',
    '            "2. \u5982\u679c next_constraint \u5df2\u5b58\u5728\u4e8e already_existing_constraints\uff0c\u5219\u8be5\u56e0\u679c\u5361\u65e0\u6548\u3002\\n"\n',
    '            "3. \u5982\u679c state_delta.before == state_delta.after\uff0c\u5219\u8be5\u56e0\u679c\u5361\u65e0\u6548\u3002\\n\\n"\n',
    ...
    '            "- scene_state\uff1a\u573a\u666f\u5165\u53e3\u72b6\u6001\uff08\u5fc5\u586b\uff09\\n"\n',
    '            "- concrete_problem\uff1a\u5fc5\u586b\\n"\n',
    '            "- causal_transitions\uff1a\u56e0\u679c\u8f6c\u6298\u6570\u7ec4\uff080\u20143 \u9879\uff09\\n"\n',
    '            "- tempo_guardrails\uff08\u53ef\u9009\uff09\\n"\n',
    '            "- chapter_contract_check\uff1a\u5fc5\u586b\uff0c\u6240\u6709\u5b57\u6bb5\u5fc5\u987b\u4e3a true\\n\\n"\n',
    '            "## \u9879\u76ee\u8bbe\u5b9a\\n"\n',
...
# Replace the planner system_template
new_lines = lines[:planner_start] + new_planner_system + lines[planner_end+1:]

with open('app/prompts/defaults.py', 'w', encoding='utf-8', newline='\r\n') as f:
    f.writelines(new_lines)

print("Updated Planner prompt with:")
print("  - planner_contract_version: 2 requirement")
print("  - Counterfactual failure conditions")
print("  - next_constraint must differ from already_existing_constraints")
print("  - turning_point must be caused by character choice")
